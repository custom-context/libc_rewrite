...
MODIFIER STRUCT_SUBTYPE(STRONG_RC, value_type)\
    RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC_METHOD(STRONG_RC, WEAK_RC, strong_rc_value)(\
        struct RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC) const* const this);\
MODIFIER STRUCT_SUBTYPE(STRONG_RC, value_type)\
    RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC_METHOD(STRONG_RC, WEAK_RC, strong_rc_inc)(\
        struct RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC)* const this);\
MODIFIER STRUCT_SUBTYPE(STRONG_RC, value_type)\
    RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC_METHOD(STRONG_RC, WEAK_RC, strong_rc_dec)(\
        struct RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC)* const this);\
MODIFIER STRUCT_SUBTYPE(WEAK_RC, value_type)\
    RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC_METHOD(STRONG_RC, WEAK_RC, weak_rc_value)(\
        struct RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC) const* const this);\
MODIFIER STRUCT_SUBTYPE(WEAK_RC, value_type)\
    RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC_METHOD(STRONG_RC, WEAK_RC, weak_rc_inc)(\
        struct RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC)* const this);\
MODIFIER STRUCT_SUBTYPE(WEAK_RC, value_type)\
    RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC_METHOD(STRONG_RC, WEAK_RC, weak_rc_dec)(\
        struct RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC)* const this);\
MODIFIER void\
...
MODIFIER RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC)*\
    ...
    TYPE_METHOD(STRONG_RC, construct_from_value_at)(&this->strong_rc, 1u);\
    TYPE_METHOD(WEAK_RC, construct_at)(&this->weak_rc);\
    return this;\
}\
MODIFIER RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC)*\
    ...
    this->INTERFACE_VTABLE_VARIABLE(RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC)) =\
        &INTERFACE_VTABLE_STATIC_VARIABLE(RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC));\
    TYPE_METHOD(STRONG_RC, construct_copy_at)(&this->strong_rc, &src->strong_rc);\
    TYPE_METHOD(WEAK_RC, construct_copy_at)(&this->weak_rc, &src->weak_rc);\
    return this;\
}\
MODIFIER RC_CTRL_BLOCK_INTERFACE_TYPE__STRONG_RC__WEAK_RC(STRONG_RC, WEAK_RC)*\
