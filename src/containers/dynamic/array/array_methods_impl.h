...
COMMON_MODIFIER void DYNAMIC_ARRAY_WITH_CUSTOM_ALLOCATOR_METHOD(TYPE, ALLOCATOR_TYPE, push_back_by_moving)(\
    ...
    \
    TYPE_METHOD(TYPE, construct_move_at)(\
        DYNAMIC_ARRAY_WITH_CUSTOM_ALLOCATOR_METHOD(TYPE, ALLOCATOR_TYPE, mut_at)(\
            this,\
            this->size++\
        ),\
        value\
...
COMMON_MODIFIER struct DYNAMIC_ARRAY_WITH_CUSTOM_ALLOCATOR_CONST_ITERATOR_TYPE(TYPE, ALLOCATOR_TYPE) DYNAMIC_ARRAY_WITH_CUSTOM_ALLOCATOR_METHOD(TYPE, ALLOCATOR_TYPE, cbegin)(\
    struct DYNAMIC_ARRAY_WITH_CUSTOM_ALLOCATOR_TYPE(TYPE, ALLOCATOR_TYPE) const* const this) {\
    ASSERT(this);\
...
COMMON_MODIFIER struct DYNAMIC_ARRAY_WITH_CUSTOM_ALLOCATOR_CONST_ITERATOR_TYPE(TYPE, ALLOCATOR_TYPE) DYNAMIC_ARRAY_WITH_CUSTOM_ALLOCATOR_METHOD(TYPE, ALLOCATOR_TYPE, cend)(\
    struct DYNAMIC_ARRAY_WITH_CUSTOM_ALLOCATOR_TYPE(TYPE, ALLOCATOR_TYPE) const* const this) {\
    ASSERT(this);\
    struct DYNAMIC_ARRAY_WITH_CUSTOM_ALLOCATOR_CONST_ITERATOR_TYPE(TYPE, ALLOCATOR_TYPE) iterator = {\
