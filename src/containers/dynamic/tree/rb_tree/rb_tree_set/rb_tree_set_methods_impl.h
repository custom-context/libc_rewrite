...
COMMON_MODIFIER void* RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, destroy_at)(\
    struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
...
COMMON_MODIFIER struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)*\
    ...
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, destroy_at)(&temporary);\
    return this;\
}\
COMMON_MODIFIER struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)*\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), size_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, size)(\
...
COMMON_MODIFIER void RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, clear)(\
    struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_TYPE(TYPE)));\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), iterator_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, insert_copy)(\
        struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this,\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), iterator_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, insert_move)(\
        struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this,\
        TYPE* const value) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_TYPE(TYPE)));\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), const_iterator_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, find)(\
        struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR) const* const this,\
        TYPE const* const value) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_TYPE(TYPE)));\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), iterator_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, mut_find)(\
        struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this,\
        TYPE const* const value) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_TYPE(TYPE)));\
...
/* --- --- erase element --- --- */\
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), iterator_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, erase_by_iterator)(\
        struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this,\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), iterator_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, erase_by_const_iterator)(\
        struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this,\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), iterator_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, begin)(\
        struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_TYPE(TYPE)));\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), iterator_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, end)(\
        struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_TYPE(TYPE)));\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), const_iterator_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, cbegin)(\
        struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_TYPE(TYPE)));\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), const_iterator_type)\
    RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, cend)(\
        struct RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_TYPE(TYPE)));\
...
COMMON_MODIFIER void* RED_BLACK_TREE_SET_TYPE_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, destroy_at)(\
    struct RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
...
COMMON_MODIFIER struct RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)*\
    ...
    RED_BLACK_TREE_SET_TYPE_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, destroy_at)(&temporary);\
    return this;\
}\
COMMON_MODIFIER struct RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)*\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), value_type)*\
    RED_BLACK_TREE_SET_TYPE_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, value)(\
        struct RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_ITERATOR_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_ITERATOR_TYPE(TYPE)));\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), value_type) const*\
    RED_BLACK_TREE_SET_TYPE_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, const_value)(\
...
COMMON_MODIFIER int RED_BLACK_TREE_SET_TYPE_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, compare)(\
    struct RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR) const* const this,\
    struct RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR) const* const source) {\
    ASSERT(this);\
    ASSERT(source);\
...
COMMON_MODIFIER struct SET_INTERFACE_ITERATOR_TYPE(TYPE)\
    RED_BLACK_TREE_SET_TYPE_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, next)(\
        struct RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_ITERATOR_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_ITERATOR_TYPE(TYPE)));\
...
COMMON_MODIFIER struct SET_INTERFACE_ITERATOR_TYPE(TYPE)\
    RED_BLACK_TREE_SET_TYPE_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, pnext)(\
        struct RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_ITERATOR_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_ITERATOR_TYPE(TYPE)));\
...
COMMON_MODIFIER struct SET_INTERFACE_ITERATOR_TYPE(TYPE)\
    RED_BLACK_TREE_SET_TYPE_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, prev)(\
        struct RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_ITERATOR_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_ITERATOR_TYPE(TYPE)));\
...
COMMON_MODIFIER struct SET_INTERFACE_ITERATOR_TYPE(TYPE)\
    RED_BLACK_TREE_SET_TYPE_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, pprev)(\
        struct RED_BLACK_TREE_SET_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_ITERATOR_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_ITERATOR_TYPE(TYPE)));\
...
COMMON_MODIFIER void* RED_BLACK_TREE_SET_TYPE_CONST_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, destroy_at)(\
    struct RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
...
COMMON_MODIFIER struct RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)*\
    ...
    RED_BLACK_TREE_SET_TYPE_CONST_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, destroy_at)(&temporary);\
    return this;\
}\
COMMON_MODIFIER struct RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)*\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), value_type)*\
    RED_BLACK_TREE_SET_TYPE_CONST_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, value)(\
        struct RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)));\
...
COMMON_MODIFIER STRUCT_SUBTYPE(RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR), value_type) const*\
    RED_BLACK_TREE_SET_TYPE_CONST_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, const_value)(\
...
/* --- Compare functions --- */\
/* return 0 if equals, !0 either */\
COMMON_MODIFIER int RED_BLACK_TREE_SET_TYPE_CONST_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, compare)(\
    struct RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR) const* const this,\
    struct RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR) const* const source) {\
    ASSERT(this);\
    ASSERT(source);\
...
COMMON_MODIFIER struct SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)\
    RED_BLACK_TREE_SET_TYPE_CONST_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, next)(\
        struct RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)));\
...
/* return this-value & point this to next value */\
COMMON_MODIFIER struct SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)\
    RED_BLACK_TREE_SET_TYPE_CONST_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, pnext)(\
        struct RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)));\
...
/* point this to previous value & return this-value */\
COMMON_MODIFIER struct SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)\
    RED_BLACK_TREE_SET_TYPE_CONST_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, prev)(\
        struct RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)));\
...
/* return this-value & point this to previous value */\
COMMON_MODIFIER struct SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)\
    RED_BLACK_TREE_SET_TYPE_CONST_ITERATOR_WITH_COMPARATOR_AND_ALLOCATOR_DYNAMIC_METHOD(TYPE, COMPARATOR, ALLOCATOR, pprev)(\
        struct RED_BLACK_TREE_SET_CONST_ITERATOR_TYPE_WITH_COMPARATOR_AND_ALLOCATOR(TYPE, COMPARATOR, ALLOCATOR)* const this) {\
    ASSERT(this);\
    ASSERT(this->INTERFACE_VARIABLE(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)).INTERFACE_VTABLE_VARIABLE(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE)));\
