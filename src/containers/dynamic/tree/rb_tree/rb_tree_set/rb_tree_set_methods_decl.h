...
#define DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_AND_MODIFIER_METHODS(COMMON_MODIFIER, TYPE, COMPARATOR, ALLOCATOR)\
/* --- Set methods --- */\
...
#define DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_METHODS(TYPE, COMPARATOR, ALLOCATOR) DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_AND_MODIFIER_METHODS(, TYPE, COMPARATOR, ALLOCATOR)
#define DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_STATIC_METHODS(TYPE, COMPARATOR, ALLOCATOR) DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_AND_MODIFIER_METHODS(static, TYPE, COMPARATOR, ALLOCATOR)
#define DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_INLINE_METHODS(TYPE, COMPARATOR, ALLOCATOR) DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_AND_MODIFIER_METHODS(inline, TYPE, COMPARATOR, ALLOCATOR)
#define DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_EXTERNAL_METHODS(TYPE, COMPARATOR, ALLOCATOR) DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_AND_MODIFIER_METHODS(extern, TYPE, COMPARATOR, ALLOCATOR)
#define DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_EXTERNAL_INLINE_METHODS(TYPE, COMPARATOR, ALLOCATOR) DECLARE_RED_BLACK_TREE_SET_WITH_COMPARATOR_AND_ALLOCATOR_AND_MODIFIER_METHODS(extern inline, TYPE, COMPARATOR, ALLOCATOR)
