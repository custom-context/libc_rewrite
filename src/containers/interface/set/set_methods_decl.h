...
#define SET_INTERFACE_DYNAMIC_METHOD(TYPE, METHOD) TYPE_DYNAMIC_METHOD(SET_INTERFACE_TYPE(TYPE), METHOD)
...
#define SET_INTERFACE_ITERATOR_DYNAMIC_METHOD(TYPE, METHOD) TYPE_DYNAMIC_METHOD(SET_INTERFACE_ITERATOR_TYPE(TYPE), METHOD)
...
#define SET_INTERFACE_CONST_ITERATOR_DYNAMIC_METHOD(TYPE, METHOD) TYPE_DYNAMIC_METHOD(SET_INTERFACE_CONST_ITERATOR_TYPE(TYPE), METHOD)
