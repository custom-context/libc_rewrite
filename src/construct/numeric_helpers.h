...
#define DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(MODIFIER, TYPE)\
MODIFIER TYPE* TYPE_METHOD(TYPE, construct_from_value_at)(TYPE* const this, STRUCT_SUBTYPE(TYPE, value_type) value);\
DECLARE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(MODIFIER, TYPE)
...
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, char);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, short);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, int);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, long);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, uchar);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, ushort);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, uint);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, ulong);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, float);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, double);

DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, int8);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, int16);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, int32);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, int64);

DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, uint8);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, uint16);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, uint32);
DECLARE_NUMERIC_TYPE_DEFAULT_LIFECYCLE_METHODS_WITH_MODIFIER(, uint64);
