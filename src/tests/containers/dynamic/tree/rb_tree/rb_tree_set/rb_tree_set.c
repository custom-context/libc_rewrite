...
DECLARE_SET_INTERFACE_TYPE(int);
...
#include <containers/interface/set/set_inheritance_vtable.h>
// set interface's inheritance methods
DEFINE_SET_INTERFACE_INHERITANCE_METHODS_WITH_MODIFIER(static, int)

// set interface's vtable
DEFINE_SET_INTERFACE_VTABLES_VARIABLES_WITH_MODIFIER(static, int);

// set interface's methods
DECLARE_SET_INTERFACE_METHODS_WITH_MODIFIER(static, int);
DEFINE_SET_INTERFACE_METHODS_WITH_MODIFIER(static, int)

// red-black tree set's methods declaration
DECLARE_RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_AND_MODIFIER_METHODS(static, int, COMPARATOR_TYPE(greater, int), PROXY_ALLOCATOR_TYPE(DEFAULT_ALLOCATOR_TYPE(RED_BLACK_TREE_SET_NODE_TYPE(int)), DebugAllocatorContext));

#include <containers/dynamic/tree/rb_tree/rb_tree_set/rb_tree_set_inheritance_methods_impl.h>
// red-black tree set's inheritance methods declaration
DECLARE_RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_AND_MODIFIER_INHERITANCE_METHODS(static, int, COMPARATOR_TYPE(greater, int), PROXY_ALLOCATOR_TYPE(DEFAULT_ALLOCATOR_TYPE(RED_BLACK_TREE_SET_NODE_TYPE(int)), DebugAllocatorContext));

#include <containers/dynamic/tree/rb_tree/rb_tree_set/rb_tree_set_inheritance_vtable.h>
// red-black tree set's vtable
DEFINE_RED_BLACK_TREE_SET_INTERFACE_VTABLES_VARIABLES_WITH_MODIFIER(static, int, COMPARATOR_TYPE(greater, int), PROXY_ALLOCATOR_TYPE(DEFAULT_ALLOCATOR_TYPE(RED_BLACK_TREE_SET_NODE_TYPE(int)), DebugAllocatorContext));

// red-black tree set's methods definition
DEFINE_RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_AND_MODIFIER_METHODS(static, int, COMPARATOR_TYPE(greater, int), PROXY_ALLOCATOR_TYPE(DEFAULT_ALLOCATOR_TYPE(RED_BLACK_TREE_SET_NODE_TYPE(int)), DebugAllocatorContext))

// red-black tree set's inheritance methods definition
DEFINE_RED_BLACK_TREE_SET_TYPE_WITH_COMPARATOR_AND_ALLOCATOR_AND_MODIFIER_INHERITANCE_METHODS(static, int, COMPARATOR_TYPE(greater, int), PROXY_ALLOCATOR_TYPE(DEFAULT_ALLOCATOR_TYPE(RED_BLACK_TREE_SET_NODE_TYPE(int)), DebugAllocatorContext))
