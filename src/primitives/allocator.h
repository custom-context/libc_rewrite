...
DEFINE_DEFAULT_ALLOCATOR_TYPE(usize);
DEFINE_DEFAULT_ALLOCATOR_TYPE(ptrdiff);
DEFINE_DEFAULT_ALLOCATOR_TYPE(intptr);
DEFINE_DEFAULT_ALLOCATOR_TYPE(uintptr);

DECLARE_DEFAULT_ALLOCATOR_METHODS_WITH_MODIFIER(extern, usize);
DECLARE_DEFAULT_ALLOCATOR_METHODS_WITH_MODIFIER(extern, ptrdiff);
DECLARE_DEFAULT_ALLOCATOR_METHODS_WITH_MODIFIER(extern, intptr);
DECLARE_DEFAULT_ALLOCATOR_METHODS_WITH_MODIFIER(extern, uintptr);
